...
import { abi, abi1, contractAddresses} from "../constants";
...
const Polygon1 = () => {
 ...
 const [states, dispatch] = useReducer(reducer, initialState)
  ...
  async function updateUIValues() {
    ...
    const price1 = (Math.round((0.1/price)*10**18)).toString()
  ...
  return (
    <div className="eth__page">
     ...
     <Details className={states.detailsState} coin='polygon1' />
    <Calendar className={states.calendarState} Name='noDisplay' coin='polygon1' />
    <Transactions className={states.transactionsState}  Name='noDisplay' coin='polygon1' />
    <Winners className={states.winnersState} Name='noDisplay' coin='polygon1'/> 
